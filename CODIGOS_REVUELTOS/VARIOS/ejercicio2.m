...
f=@(x)1/x^2*sqrt(1+x); %definiendo funcion
a=1.5; %punto alrededor del cual se calcula el polinomio de Taylor
%codigo principal
...
%---------------------APROXIMACIONES--------------------------------------%
V_aprox(1)=subs(P_4,1);%valor aprox
V_aprox(2)=subs(P_7,1);%valor aprox
